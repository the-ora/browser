    ...
    func makeNSView(context: Context) -> NSView {
        ...
        DispatchQueue.main.async {
            if let window = view.window {
                ...
                let enterObs = NotificationCenter.default.addObserver(forName: NSWindow.didEnterFullScreenNotification, object: window, queue: nil, using: coord.didEnterFullScreen)

                let exitObs = NotificationCenter.default.addObserver(forName: NSWindow.didExitFullScreenNotification, object: window, queue: nil, using: coord.didExitFullScreen)
